...
def mota(df, num_misses, num_switches, num_false_positives, num_objects):
    ...
    del df  # unused
    # print(num_misses, num_switches, num_false_positives)
    return 1.0 - math_util.quiet_divide(
        num_misses + num_switches + num_false_positives, num_objects
    )

def mota_fus(df, num_misses, num_switches, num_false_positives, num_objects):
    """Multiple object tracker accuracy."""
    del df  # unused
    return 1.0 - math_util.quiet_divide(
...
def create():
    ...
    m.register(mota_fus, formatter="{:.1%}".format)
